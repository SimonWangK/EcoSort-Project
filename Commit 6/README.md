...
**Commit 06** — `feat: add onboarding and permission explanation screen`

Add an onboarding flow that explains camera/location permissions before requesting them.
