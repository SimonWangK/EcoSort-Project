  ...
  return (
    <View style={styles.card}>
      <View style={styles.sectionHeader}>
        <Text style={scaleTextStyle(styles.sectionTitle, textScale)}>Recent check</Text>
        <TouchableOpacity onPress={onViewAll}>
          <Text style={scaleTextStyle(styles.viewAllText, textScale)}>View all</Text>
        </TouchableOpacity>
      </View>
      ...
      {entry ? (
        ...
        <View style={styles.recentItemRow}>
          ...
          <View style={styles.itemDetails}>
            <Text style={scaleTextStyle(styles.itemName, textScale)} numberOfLines={1}>
              {entry.item}
            </Text>
            <View style={styles.itemTags}>
              <Text style={scaleTextStyle(styles.tagGreen, textScale)} numberOfLines={1}>
                {entry.binLabel}
              </Text>
              <View style={styles.tagDot} />
              <Text style={scaleTextStyle(styles.tagGray, textScale)}>{entry.council}</Text>
            </View>
          </View>
        </View>
      ) : (
        ...
        <View style={styles.recentItemRow}>
          ...
          <View style={styles.itemDetails}>
            <Text style={[scaleTextStyle(styles.itemName, textScale), { color: '#8E928F' }]}>No checks yet</Text>
            <View style={styles.itemTags}>
              <Text style={scaleTextStyle(styles.tagGray, textScale)}>Search or scan an item to start</Text>
            </View>
          </View>
        </View>
      )}
...
export function HomeScreen({
  ...
  const councilLabel = settings.locationCouncil || 'Yarra Council';
  ...
  const locationHeaderNode = (
    ...
    >
      <Text style={scaleTextStyle(styles.locationLabel, textScale)} numberOfLines={1}>
        {councilLabel}
      </Text>
      <View style={styles.locationDivider} />
      <Text style={scaleTextStyle(styles.locationAction, textScale)}>Change</Text>
    </Pressable>
  );
  ...
  return (
    <Screen title="" headerRight={locationHeaderNode}>
      ...
      <View style={styles.customHeader}>
        <Text style={scaleTextStyle(styles.titleBlack, textScale)}>Sort with</Text>
        <Text style={scaleTextStyle(styles.titleGreen, textScale)}>confidence.</Text>
        <Text style={scaleTextStyle(styles.subtitle, textScale)}>
      ...
      <View style={styles.card}>
        <View style={styles.searchRow}>
          ...
          >
            ...
            <View pointerEvents="none" style={{ flex: 1 }}>
              <TextInput
                style={scaleTextStyle(styles.searchInput, textScale)}
        ...
        <View style={styles.dividerRow}>
          ...
          <Text style={scaleTextStyle(styles.dividerText, textScale)}>or</Text>
          <View style={styles.dividerLine} />
        </View>
        ...
        >
          ...
          <Text style={scaleTextStyle(styles.scanItemText, textScale)}>Scan an item</Text>
      ...
      <View style={styles.impactCard}>
        <View style={styles.impactHeader}>
          ...
          <Text style={scaleTextStyle(styles.impactTitle, textScale)}>Your impact</Text>
        </View>

        <View style={styles.statsRow}>
          <View style={styles.statBox}>
            <Feather name="clock" size={18} color="#2E6C4C" style={styles.statIcon} />
            <Text style={scaleTextStyle(styles.statValue, textScale)}>{history.length}</Text>
            <Text style={scaleTextStyle(styles.statLabel, textScale)}>Items checked</Text>
          </View>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={scaleTextStyle(styles.statValue, textScale)}>{points}</Text>
            <Text style={scaleTextStyle(styles.statLabel, textScale)}>Eco points</Text>
          </View>
          ...
          <View style={styles.statBox}>
            ...
            <Text style={scaleTextStyle(styles.statValue, textScale)} numberOfLines={1} adjustsFontSizeToFit>
              {formatKg(co2)} <Text style={scaleTextStyle(styles.statUnit, textScale)}></Text>
            </Text>
            <Text style={scaleTextStyle(styles.statLabel, textScale)}>CO₂ saved</Text>
          </View>
        </View>
      </View>
