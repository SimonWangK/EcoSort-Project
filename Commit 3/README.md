...
**Commit 03** — `feat: implement council rule search and result guidance`

Implement local council rule data, manual item search, matching logic, and result guidance.
